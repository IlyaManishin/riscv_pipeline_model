...
class CpuSystem:
    ...
    def __init__(self,
        ...
        self.core = Core(self.clk, rst_reg=self.rst_reg)

    def step(self) -> None:

        # 1. Instruction Fetch Stage
        imem_addr = self.core.get_imem_addr()
        ...
        dmem_data = self.core.dec_exec_alu(instr)
        ...
        if is_dmem_access:
            ...
            if dmem_data.byte_we != 0:
                self.dmem.write(word_dmem_addr, dmem_data.wdata,
        ...
        self.core.write_back_comb(dmem_data_in=data_to_cpu)
